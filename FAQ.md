...
Use HTTP only on a network you trust. For remote access, configure HTTPS and note that you may need to [configure your certificates](#what-is-an-invalid-certificate) before NAS Download Manager can log in.
...
## What's the difference between NAS Download Manager and Synology Download Station?

NAS Download Manager is the browser extension in this repository. Synology Download Station is the application running on the NAS that the extension controls.
